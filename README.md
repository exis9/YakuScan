...
<p align="center">
  <b>Amazing language-learning OCR tool for video game players</b>
</p>
...
Have you ever given up trying to play a game in a foreign language?

YakuScan is a tool that can extract text from any selected area, image, or window on your screen.

It can also integrate with local AI or dictionary websites, allowing you to look up word meanings, generate example sentences, and translate text.

It even supports text-to-speech (TTS), making it a reliable companion while you play.

Even though setting up local AI is usually very complex, this tool includes a fully automatic setup button — so you can complete everything with just a single click.
